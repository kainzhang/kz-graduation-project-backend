...
class DoubanLoginMiddleware:
    ...
    def get_img(self, driver):
        ...
        urlretrieve(src0, 'crawler/captcha_img/' + img0_name)
        urlretrieve(src1, 'crawler/captcha_img/' + img1_name)
        time.sleep(3)
        img0 = Image.open('crawler/captcha_img/' + img0_name)
        img1 = Image.open('crawler/captcha_img/' + img1_name)
        """
        下载的图片尺寸：680 * 390
        验证码图片尺寸：340 * 195 
        """
